---------------------------------------------------------------------------
-- QuaziiUI Combat Text Indicator
-- Displays +Combat or -Combat when entering/leaving combat
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...

if not ns.ShouldLoadModule("combattext", { name = "Combat Text", enabled = true }) then
    return
end
...
local function CreateTextFrame()
    ...
    local frame = CreateFrame("Frame", "QuaziiUI_CombatText", UIParent)
...
---------------------------------------------------------------------------
_G.QuaziiUI_RefreshCombatText = RefreshCombatText

---------------------------------------------------------------------------
-- Global preview function for options panel
---------------------------------------------------------------------------
_G.QuaziiUI_PreviewCombatText = function(message)
...
QUI.CombatText = {
    ...
    Show = ShowCombatText,
    Preview = _G.QuaziiUI_PreviewCombatText,
}
