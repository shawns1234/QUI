...
if not ns.ShouldLoadModule("datatexts", { name = "Datatexts", enabled = true }) then
    return
end
...
local DUNGEON_SHORT_NAMES = {
    -- Burning Crusade
    -- (Magister's Terrace moved to Midnight)
    ...
    [56] = "SSB",        -- Stormstout Brewery
    [57] = "GOTSS",      -- Gate of the Setting Sun
    [58] = "SPM",        -- Shado-Pan Monastery
    [59] = "SNT",        -- Siege of Niuzao Temple
    [60] = "MSP",        -- Mogu'shan Palace
    [76] = "SCHOLO",     -- Scholomance
    [77] = "SH",         -- Scarlet Halls
    ...
    [167] = "UBRS",      -- Upper Blackrock Spire
    ...
    [207] = "VAULT",     -- Vault of the Wardens
    [208] = "MOS",       -- Maw of Souls
    [209] = "ARC",       -- The Arcway
    [210] = "COS",       -- Court of Stars
    [227] = "KARA",      -- Lower Karazhan
    [234] = "KARA",      -- Upper Karazhan
    ...
    [252] = "SHRINE",    -- Shrine of the Storm
    [353] = "SIEGE",     -- Siege of Boralus
    [369] = "YARD",      -- Mechagon Junkyard
    [370] = "MECHA",     -- Mechagon Workshop
    ...
    -- Midnight (S1)
    [557] = "WIND",      -- Windrunner Spire
    [558] = "MAGI",      -- Magister's Terrace
    [559] = "XENAS",     -- Nexus-Point Xenas
    [560] = "CAVNS",     -- Maisara Caverns
    -- Midnight (S2+) - TBD: Murder Row, Den of Nalorakk, Blinding Vale, Voidscar Arena
}

local function GetShortDungeonName(mapID)
    if DUNGEON_SHORT_NAMES[mapID] then
        return DUNGEON_SHORT_NAMES[mapID]
    end
    -- Fallback: get full name and take first word
