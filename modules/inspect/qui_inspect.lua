...
local function CreateInspectSettingsButton()
    ...
    inspectSettingsPanel = CreateFrame("Frame", "QuaziiUI_InspectSettingsPanel", InspectFrame, "BackdropTemplate")
