---------------------------------------------------------------------------
-- QuaziiUI Reticle Module
-- GCD tracker ring that follows the mouse cursor with center reticle
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...

if not ns.ShouldLoadModule("reticle", { name = "Reticle", enabled = true }) then
    return
end
...
---------------------------------------------------------------------------
local RING_TEXTURES = {
    thin     = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_ring_thin.png",
    standard = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_ring_standard.png",
    thick    = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_ring_thick.png",
    solid    = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_ring_solid.png",
}

-- Reticle options (mix of custom texture and Blizzard Atlas)
local RETICLE_OPTIONS = {
    dot     = { path = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_reticle_dot.tga", isAtlas = false },
...
local function CreateReticle()
    ...
    ringFrame = CreateFrame("Frame", "QuaziiUI_Reticle", UIParent)
...
---------------------------------------------------------------------------
_G.QuaziiUI_RefreshReticle = function()
    InvalidateCache()
    UpdateReticle()
end
