---------------------------------------------------------------------------
-- QuaziiUI Skyriding Module
-- Unified continuous vigor bar with segment markers
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...

if not ns.ShouldLoadModule("skyriding", { name = "Skyriding", enabled = true }) then
    return
end
...
-- Texture paths
local DOT_TEXTURE = "Interface\\AddOns\\QuaziiUI\\assets\\cursor\\qui_reticle_dot"
...
---------------------------------------------------------------------------
_G.QuaziiUI_RefreshSkyriding = ApplySettings
