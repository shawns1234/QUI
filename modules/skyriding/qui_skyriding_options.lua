--[[
    qui_skyriding_options.lua
    Options UI for Skyriding Vigor Bar component
]]
...
if not ns.IsModuleEnabled("skyriding") then
    return
end

-- Build dragonriding tab
...
-- Export
local SkyridingOptions = {
    BuildDragonridingTab = BuildDragonridingTab,
}

return SkyridingOptions
