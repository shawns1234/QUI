...
_G.QuaziiUI_UpdateLockedPowerBar = function()
    local QUICore = _G.QuaziiUI and _G.QuaziiUI.QUICore
...
_G.QuaziiUI_UpdateLockedPowerBarToUtility = function()
    local QUICore = _G.QuaziiUI and _G.QuaziiUI.QUICore
    if not QUICore or not QUICore.db then return end
...
_G.QuaziiUI_UpdateLockedSecondaryPowerBar = function()
    local QUICore = _G.QuaziiUI and _G.QuaziiUI.QUICore
    if not QUICore or not QUICore.db then return end
...
_G.QuaziiUI_UpdateLockedSecondaryPowerBarToUtility = function()
    local QUICore = _G.QuaziiUI and _G.QuaziiUI.QUICore
    if not QUICore or not QUICore.db then return end
