...
local function LayoutViewer(viewerName, trackerKey)
    ...
    if not viewer.__cdmUpdatePending then
        ...
        C_Timer.After(0.05, function()
            ...
            if trackerKey == "essential" then
                if _G.QuaziiUI_UpdateLockedPowerBar then
                    _G.QuaziiUI_UpdateLockedPowerBar()
                end
                if _G.QuaziiUI_UpdateLockedSecondaryPowerBar then
                    _G.QuaziiUI_UpdateLockedSecondaryPowerBar()
                end
                if _G.QuaziiUI_UpdateLockedCastbarToEssential then
                    _G.QuaziiUI_UpdateLockedCastbarToEssential()
                end
            elseif trackerKey == "utility" then
                if _G.QuaziiUI_UpdateLockedPowerBarToUtility then
                    _G.QuaziiUI_UpdateLockedPowerBarToUtility()
                end
                if _G.QuaziiUI_UpdateLockedSecondaryPowerBarToUtility then
                    _G.QuaziiUI_UpdateLockedSecondaryPowerBarToUtility()
                end
                if _G.QuaziiUI_UpdateLockedCastbarToUtility then
                    _G.QuaziiUI_UpdateLockedCastbarToUtility()
                end
            end
    ...
    viewer:HookScript("OnShow", function(self)
        ...
        C_Timer.After(0.02, function()
            if self:IsShown() then
                ...
                if trackerKey == "utility" and _G.QuaziiUI_ApplyUtilityAnchor then
                    _G.QuaziiUI_ApplyUtilityAnchor()
                end
            end
        end)
...
_G.QuaziiUI_ApplyUtilityAnchor = ApplyUtilityAnchor
