...
_G.QuaziiUI_RefreshKeyTrackerColors = ApplySkinColors
...
_G.QuaziiUI_RefreshKeyTrackerFonts = UpdateAllButtonFonts
...
KeyTrackerFrame:SetScript("OnMouseUp", function(self, button)
    if button == "RightButton" and not InCombatLockdown() then
        RequestKeystones()
        print("|cFF56D1FFQuaziiUI:|r Refreshing party keys...")
    end
end)
