---------------------------------------------------------------------------
-- QuaziiUI Blizzard Options Integration
-- Registers QuaziiUI in Settings > AddOns panel
---------------------------------------------------------------------------
local ADDON_NAME, ns = ...
local QUI = QuaziiUI

local ADDON_DISPLAY_NAME = "Quazii UI"

local function OpenQuaziiUI()
    if QUI.GUI then
        QUI.GUI:Toggle()
        return true
    end
    print("|cFF56D1FFQuaziiUI:|r GUI not loaded yet. Try /qui instead.")
    return false
end
...
local function CreateSettingsPanel()
    ...
    local panel = CreateFrame("Frame", "QuaziiUI_BlizzardSettingsPanel")
