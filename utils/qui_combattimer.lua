...
local function CreateTimerFrame()
    ...
    local frame = CreateFrame("Frame", "QuaziiUI_CombatTimer", UIParent, "BackdropTemplate")
...
---------------------------------------------------------------------------
_G.QuaziiUI_RefreshCombatTimer = RefreshCombatTimer
_G.QuaziiUI_ToggleCombatTimerPreview = TogglePreview
_G.QuaziiUI_IsCombatTimerPreviewMode = IsPreviewMode
