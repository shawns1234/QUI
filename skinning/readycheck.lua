...
_G.QuaziiUI_ResetReadyCheckPosition = ResetReadyCheckPosition
...
local function CreateMover()
    ...
    readyCheckMover = CreateFrame("Frame", "QuaziiUI_ReadyCheckMover", UIParent, "BackdropTemplate")
...
_G.QuaziiUI_ToggleReadyCheckMover = ToggleMover
...
_G.QuaziiUI_RefreshReadyCheckColors = RefreshReadyCheckColors
