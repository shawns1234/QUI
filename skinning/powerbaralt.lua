...
local function CreateQUIAltPowerBar()
    ...
    local bar = CreateFrame("StatusBar", "QuaziiUI_AltPowerBar", UIParent)
...
_G.QuaziiUI_RefreshPowerBarAltColors = RefreshPowerBarAltColors
...
local function CreateMover()
    ...
    powerBarMover = CreateFrame("Frame", "QuaziiUI_AltPowerBarMover", UIParent, "BackdropTemplate")
...
_G.QuaziiUI_TogglePowerBarAltMover = ToggleMover
