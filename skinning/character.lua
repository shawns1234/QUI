...
local function GetFontPath()
    ...
    return (LSM and settings and LSM:Fetch("font", settings.font or "Quazii")) or STANDARD_TEXT_FONT
end
...
local function SkinEquipmentManager()
    ...
    local popup = _G.QuaziiUI_EquipMgrPopup
...
local function SkinTitleManagerPane()
    ...
    local popup = _G.QuaziiUI_TitlesPopup
...
_G.QuaziiUI_RefreshCharacterFrameColors = RefreshCharacterFrameColors
