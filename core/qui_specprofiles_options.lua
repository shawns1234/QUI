--[[
    qui_specprofiles_options.lua
    Options UI for Spec Profiles component
]]
...
---------------------------------------------------------------------------
-- Import CreateScrollableTextBox from shared
local CreateScrollableTextBox = OptionsShared.CreateScrollableTextBox
...
-- Export the function
ns.SpecProfilesOptions = { CreateSpecProfilesPage = CreateSpecProfilesPage }

-- Register with Options Page Registry
if ns.OptionsPageRegistry then
    ns.OptionsPageRegistry:RegisterSimplePage("spec_profiles", "Spec Profiles", CreateSpecProfilesPage, 110)
end
return ns.SpecProfilesOptions
