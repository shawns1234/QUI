--[[
    qui_hudvisibility_options.lua
    Options UI for HUD Visibility tab (General & QoL page)
    Controls visibility of CDM, Unit Frames, and Custom Trackers
]]
...
-- Export
local HUDVisibilityOptions = {
    BuildHUDVisibilityTab = BuildHUDVisibilityTab,
}

ns.HUDVisibilityOptions = HUDVisibilityOptions
return HUDVisibilityOptions
